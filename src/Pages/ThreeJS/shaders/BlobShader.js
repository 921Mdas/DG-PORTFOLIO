...
float cnoise(vec3 P){
  ...
  void main(){
    ...
    float elevation = sin(modelPosition.x * uElevation * uTime * 0.1) * sin(modelPosition.y * uElevation * uTime * 0.1) ;
...
const Apple = props => {
  ...
  const { nodes } = useGLTF("./model/apple.glb");
        ...
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group rotation={[-Math.PI / 2, 0, Math.PI]}>
            <mesh
              ...
              castShadow
              receiveShadow
              geometry={nodes.Apple_Cut_Low001_Apple_Baked_0.geometry}
            >
              {shaderState ? (
