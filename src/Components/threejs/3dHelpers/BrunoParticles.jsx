// import TouchTexture from "./BrunoTouchTexture";
// import * as THREE from "three";
// import gsap from "gsap";
// import { brunoFrag } from "../Effect/Shaders/Particlefrag";
// import { brunoVert } from "../Effect/Shaders/Particlevert";
...
//       uniforms,
//       vertexShader: brunoVert,
//       fragmentShader: brunoFrag,
//       depthTest: false,
//       transparent: true,
...
import * as THREE from "three";
import { LinearFilter, RGBFormat, TextureLoader } from "three";
...
const Particles = ({ src }) => {
  ...
  useFrame(() => {
    // Update particle positions, sizes, colors, etc.
    if (pointsRef.current) {
      // Modify particle attributes here
    }
  });
  ...
  return (
    <points ref={pointsRef}>
      {texture && (
        <bufferGeometry>
          {/* Define your particle vertices and attributes */}
        </bufferGeometry>
      )}
      {texture && (
        <pointsMaterial
